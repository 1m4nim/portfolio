  ...
  contents: [
    {
      ...
      profile:
        "菌類をこよなく愛する人間です。推しはテングタケ属(Amanita)です。最近になって(2024/01~)本腰を入れてプログラミングを始めました。それまでは、HTML＆CSSばかり触っており、自分のできることしか使わずに成果物を生み出していましたが、「動的なWEBサイトを作りたい」という気持ちが出てきたことをきっかけにJavaScriptに手を出してみたり、今まで知らなかったことを自分なりに解釈して触ってみたりしています。このポートフォリオサイトはNext.jsとMicroCMSをつかって作りました、今まで自分が触ったことのなかった技術を使って作成したので優しい目で見ていただけると嬉しいです。よろしくお願いします。",
